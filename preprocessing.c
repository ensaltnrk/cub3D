...
void	alloc_map(t_cub *data, char **line)
{
	int	x;
	int	y;
	int	i;
...
void	get_content(t_cub *data, char **line)
{
	int	x;
	int	y;
	int	lock;
...
void	image_controller(t_cub *data)
{
...
void	get_textures(t_cub *data, t_map *map)
{
